...
export { default as ProfileSettings } from './my_profile';
...
export { default as AuctionPaymentSettings } from './auction_payment';
export { default as ContactUsSettings } from './contact_us';
