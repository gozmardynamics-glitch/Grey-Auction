...
import {
  ...
  buyerSecurityOptionsSchema,
  type BuyerChangePasswordValues,
  type BuyerSecurityOptionsValues,
} from '../../models/schema';

export default function BuyerAuthenticationsModule() {
  // ─── Change Password Form ────────────────────────────────────────
  const passwordForm = useForm<BuyerChangePasswordValues>({
  ...
  const securityForm = useForm<BuyerSecurityOptionsValues>({
    resolver: zodResolver(buyerSecurityOptionsSchema),
    defaultValues: {
      twoFactorAuth: false,
    },
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] items-start gap-x-8 gap-y-3 md:gap-y-5">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Temporarily restrict access to your profile and transactions.
            </p>
          </div>
          <div>
