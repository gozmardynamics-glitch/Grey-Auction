  ...
  return (
    <section className="py-8">
      ...
      >
        ...
        {/* Category Tabs */}
        <div className="mb-8 flex gap-3 overflow-x-auto pb-2 md:grid md:grid-cols-5 md:overflow-visible md:pb-0">
          {visibleCategories.map((category) => {
            ...
            return (
              <Button
                ...
                className={`flex shrink-0 items-center justify-center gap-2 rounded-xl border border-border py-10 transition-all ${
                  isSelected
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/20 p-2">
                  <Image
                    src={category.image}
                    alt={category.name}
                    width={40}
