...
export const config = {
  matcher: [
    // Skip Next.js internals and static files. G34: xml/txt must be here —
    // without them /sitemap.xml and /robots.txt are treated as locale-less
    // page routes, redirected to /en/sitemap.xml, and 404.
